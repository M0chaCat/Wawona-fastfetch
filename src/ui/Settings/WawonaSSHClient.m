...
// Note: WawonaSSHClient is deprecated - using OpenSSH binary instead
...
- (BOOL)connect:(NSError **)error {
  if (error) {
    *error = [NSError errorWithDomain:@"WawonaSSHClient"
                                  code:-1
                              userInfo:@{NSLocalizedDescriptionKey: @"WawonaSSHClient is deprecated. Use OpenSSH binary instead."}];
  }
  return NO;
}
