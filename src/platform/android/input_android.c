...
uint32_t android_keycode_to_linux(uint32_t android_keycode) {
  ...
  /* Letters A-Z: Android 29-54 maps to Linux KEY_A 30 through KEY_Z 44 */
  case AKEYCODE_A:
    return KEY_A;
  case AKEYCODE_B:
    return KEY_B;
  ...
  case AKEYCODE_DPAD_UP_2:
    return KEY_UP;
  case AKEYCODE_DPAD_DOWN:
  case AKEYCODE_DPAD_DOWN_2:
    return KEY_DOWN;
  case AKEYCODE_DPAD_LEFT:
  case AKEYCODE_DPAD_LEFT_2:
    return KEY_LEFT;
  case AKEYCODE_DPAD_RIGHT:
  case AKEYCODE_DPAD_RIGHT_2:
    return KEY_RIGHT;
  /* Special */
  case AKEYCODE_ENTER:
  case AKEYCODE_DPAD_CENTER:
  case AKEYCODE_DPAD_CENTER_2:
    return KEY_ENTER;
  case AKEYCODE_TAB:
    return KEY_TAB;
  case AKEYCODE_SPACE:
  ...
  case AKEYCODE_HOME:
    return KEY_HOME;
  case AKEYCODE_ENDCALL: /* often End */
    return KEY_END;
  /* Punctuation */
  case AKEYCODE_COMMA:
    return KEY_COMMA;
  ...
  case AKEYCODE_GRAVE:
    return KEY_GRAVE;
  default:
    /* Pass through - some Android codes match Linux */
