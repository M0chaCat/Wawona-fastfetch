...
let
  ...
  pkgs.stdenv.mkDerivation {
    ...
    configurePhase = ''
      ...
      export CC="$IOS_CC"
      export CFLAGS="-arch arm64 -target arm64-apple-ios15.0-simulator -isysroot $SDKROOT -mios-simulator-version-min=15.0 -fPIC"
...
SSH_MAIN_EOF
  ...
  configurePhase = ''
    ...
    # ========================================
    export CFLAGS="-arch arm64 -target arm64-apple-ios15.0-simulator -isysroot $SDKROOT -mios-simulator-version-min=15.0 -fPIC -I${zlib}/include -I${openssl}/include"
    export CXXFLAGS="-arch arm64 -target arm64-apple-ios15.0-simulator -isysroot $SDKROOT -mios-simulator-version-min=15.0 -fPIC -I${zlib}/include -I${openssl}/include"
    export LDFLAGS="-arch arm64 -target arm64-apple-ios15.0-simulator -isysroot $SDKROOT -mios-simulator-version-min=15.0 -L${zlib}/lib -L${openssl}/lib"
